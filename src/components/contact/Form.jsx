...
export default function Form() {
  ...
  const sendEmail = (params) => {
    ...
    emailjs
      ...
      .then(
        () => {
          toast.success("We have recived your message, we will get back to you soon.", {
            id: toastid 
          })
        },
        (error) => {
          toast.error("There was an error sending your message, please try again latter.", {
            id: toastid 
          })
        },
      );
...
animate="show"
    ...
    >
      ...
      variants={item}
        ...
        className="w-full rounded-md p-2 shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 custom-bg"
      />
      {
